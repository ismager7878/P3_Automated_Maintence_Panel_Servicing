...
Create the virtual environment, use
~~~
virtualenv -p python3 --system-site-packages .venv
~~~
Make sure colcon doesnt build the venv
~~~
...
~~~
python3 -m pip install ./src/amps-python/requirements.txt
~~~

#### You dont need to be inside the venv to build
